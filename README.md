...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dnabot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14690&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dnabot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dnabot` can be installed with:

```
conda install dnabot
```

It is possible to list all of the versions of `dnabot` available on your platform with:
